function main(): void{
    ...
    const monthBeforeLast_workingHours1 = getHours(monthBeforeLast_Events,eventName1);
    const monthBeforeLast_workingHours2 = getHours(monthBeforeLast_Events,eventName2);

    const hourlyWage1:number = parseInt(scriptProperties.getProperty('WAGE1') || "0");
    const hourlyWage2:number = parseInt(scriptProperties.getProperty('WAGE2') || "0");
